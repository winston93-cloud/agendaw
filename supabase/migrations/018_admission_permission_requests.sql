...
-- Motivo: en algunos proyectos ya existe public.permission_requests con otro esquema (p.ej. RH).
-- Esta tabla evita colisiones y mantiene el dashboard de directoras estable.
